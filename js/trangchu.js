window.onload = function () {
	...
	var company = ["Hikvision.jpg", "Imou.jpg", "Kbvision.jpg", "Ezviz.jpg", "Dahua.jpg","Ổ_Cứng.jpg"
	];
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('QUÀ TẶNG', yellow_red, ['promo=tragop', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('GIẢM GIÁ', green, ['promo=giamgia', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('TẤT CẢ SẢN PHẨM', green, ['price=0-3000000000000', 'sort=price'], soLuong, div);
	}
...
function priceToString(min, max) {
	if (min == 0) return 'Tất Cả ' + ' Sản Phẩm';
