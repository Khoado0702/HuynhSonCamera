...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Huỳnh Sơn Camera</a> - All rights reserved © 2024 - Bản quyền thuộc về
            <span style="color: #eee; font-weight: bold">Huỳnh Sơn Camera</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Sản phẩm đa dạng, thích hợp mọi loại địa hình</li>
                <li>Thanh toán linh hoạt: tiền mặt, ngân hàng</li>
                <li>Trải nghiệm sản phẩm trước khi lắp đặt</li>
                <li>Tư vấn Camera và lắp đặt</li>
                <li>Bảo hành 24 tháng cho mọi sản phẩm
                    <br>Hotline1:
                    <a href="tel:0902451604" style="color: #288ad6;">0902451604</a>
                    <br>Hotline2:
                    <a href="tel:0364143136" style="color: #288ad6;">0364143136</a>
                </li>
            </ul>
        </section>
    </div>`);
        ...
        s.innerHTML = `
			(function () {
				...
				for (var li of li_s) {
					...
					switch (loai) {
						case "Độ phân giải và tốc độ ghi hình:":
						...
						case "Phần mềm:":
							...
							break;
						case "Tầm nhìn xa hồng ngoại:":
							result.detail.ram = giatri;
							break;
						case "Lưu trữ và nguồn điện:":
							result.detail.rom = giatri;
							break;
						case "Cảm biến hình ảnh:":
							result.detail.microUSB = giatri;
							break;
						case "Chuẩn chống nước:":
